  ...
  const catalog = [
    {
      ...
      options: [
        ["Pastor unidad", 8500, "1 taco de pastor"],
        ["Pastor orden x3", 23000, "Orden x3 tacos de pastor"],
        ["Pastor orden x5", 39000, "Orden x5 tacos de pastor"],
        ["Pastor orden x10", 67500, "Orden x10 tacos de pastor"],
        ["Carnitas unidad", 8500, "1 taco de carnitas"],
        ["Carnitas orden x3", 23000, "Orden x3 tacos de carnitas"],
        ["Carnitas orden x5", 39000, "Orden x5 tacos de carnitas"],
        ["Carnitas orden x10", 67500, "Orden x10 tacos de carnitas"],
        ["Longaniza orden x3", 26500, "Orden x3 tacos de longaniza"],
        ["Longaniza orden x5", 44000, "Orden x5 tacos de longaniza"],
        ["Longaniza orden x10", 87500, "Orden x10 tacos de longaniza"],
        ["Suadero unidad", 8500, "1 taco de suadero"],
        ["Suadero orden x3", 23000, "Orden x3 tacos de suadero"],
        ["Suadero orden x5", 39000, "Orden x5 tacos de suadero"],
        ["Suadero orden x10", 67500, "Orden x10 tacos de suadero"],
        ["Tripa unidad", 8500, "1 taco de tripa"],
        ["Tripa orden x3", 23000, "Orden x3 tacos de tripa"],
        ["Tripa orden x5", 39000, "Orden x5 tacos de tripa"],
        ["Tripa orden x10", 67500, "Orden x10 tacos de tripa"],
        ["Birria unidad", 9000, "1 taco de birria"],
        ["Birria orden x3", 26500, "Orden x3 tacos de birria"],
        ["Birria orden x5", 44000, "Orden x5 tacos de birria"],
        ["Birria orden x10", 86500, "Orden x10 tacos de birria"],
        ["Campechano unidad", 8500, "1 taco campechano"],
        ["Campechano orden x3", 23000, "Orden x3 tacos campechanos"],
        ["Campechano orden x5", 39000, "Orden x5 tacos campechanos"],
        ["Campechano orden x10", 77500, "Orden x10 tacos campechanos"],
        ["Pollo orden x3", 29500, "Orden x3 tacos de pollo"],
        ["Pollo orden x5", 49000, "Orden x5 tacos de pollo"],
        ["Pollo orden x10", 96500, "Orden x10 tacos de pollo"],
    ...
    },
    {
      ...
      optionsLabel: "Tipo",
      options: [
        ["Tripa, carnitas o pastor", 26000, "Burrito de tripa, carnitas o pastor"],
        ["Suadero, pollo o longaniza", 28000, "Burrito de suadero, pollo o longaniza"],
        ["Mixto dos carnes", 28000, "Burrito mixto dos carnes"],
        ["Birria", 29000, "Burrito de birria"],
        ["Burro especial", 33000, "Burro especial gratinado"],
      ].map(([label, price, line]) => ({ label, price, line })),
    },
    {
      id: "quesadilla",
      ...
      options: [
        ["Solo queso solita", 18000, "Quesadilla solo queso solita"],
        ["Solo queso acompañada", 22000, "Quesadilla solo queso acompañada"],
        ["Sincronizada solita", 18000, "Sincronizada solita"],
        ["Sincronizada acompañada", 22000, "Sincronizada acompañada"],
        ["Carnitas, pastor o tripa solita", 19000, "Quesadilla de carnitas, pastor o tripa solita"],
        ["Carnitas, pastor o tripa acompañada", 23000, "Quesadilla de carnitas, pastor o tripa acompañada"],
        ["Suadero, pollo o longaniza solita", 20000, "Quesadilla de suadero, pollo o longaniza solita"],
        ["Suadero, pollo o longaniza acompañada", 24000, "Quesadilla de suadero, pollo o longaniza acompañada"],
        ["Quesadilla Maya solita", 22000, "Quesadilla Maya solita"],
        ["Quesadilla Maya acompañada", 26000, "Quesadilla Maya acompañada"],
        ["Quesabirria solita", 23000, "Quesabirria solita"],
        ["Quesabirria acompañada", 27000, "Quesabirria acompañada"],
        ["Mixta dos carnes solita", 22000, "Quesadilla mixta dos carnes solita"],
        ["Mixta dos carnes acompañada", 26000, "Quesadilla mixta dos carnes acompañada"],
      ].map(([label, price, line]) => ({ label, price, line })),
    ...
    ...["Chilaquiles", "Alambre", "Cazuela de queso", "Costra de queso"].map((name) => ({
      ...
      options:
        name === "Chilaquiles"
          ? [
              ["Tripa, carnitas o pastor", 33000],
              ["Suadero, longaniza o pollo", 35000],
              ["Birria", 37000],
            ].map(([label, price]) => ({ label, price, line: `${name} de ${label.toLowerCase()}` }))
          : name === "Alambre"
          ? [
              ["Tripa, carnitas o pastor", 35000],
              ["Suadero, longaniza o pollo", 37000],
              ["Birria", 39000],
            ].map(([label, price]) => ({ label, price, line: `${name} de ${label.toLowerCase()}` }))
          : [
              ["Tripa, carnitas o pastor", 34000],
              ["Suadero, longaniza o pollo", 36000],
              ["Birria", 38000],
            ].map(([label, price]) => ({ label, price, line: `${name} de ${label.toLowerCase()}` })),
    })),
    {
      ...
      options: [
        ["Tripa, carnitas o pastor personal", 16000],
        ["Tripa, carnitas o pastor para compartir", 29000],
        ["Suadero, pollo o longaniza personal", 17000],
        ["Suadero, pollo o longaniza para compartir", 30000],
        ["Nachos Botanazo personal", 19000],
        ["Nachos Botanazo para compartir", 32000],
        ["Birria personal", 18000],
        ["Birria para compartir", 32000],
    ...
    },
    {
      ...
      optionsLabel: "Carne",
      options: [
        ["Tripa, carnitas o pastor", 21000],
        ["Suadero, pollo o longaniza", 22000],
        ["Birria", 24000],
    ...
    },
    {
      ...
      optionsLabel: "Tipo",
      options: [
        ["Dorielote / Takiselote", 15000],
        ["Con carne (Doritos/Takis)", 20000],
        ["Flamin' Hot", 26000],
        ["Birria elote", 29000],
        ["Elote Botanazo", 28000],
    ...
    },
    {
      ...
      options: [
        ...
        ["Dos carnes", 22000],
        ["Flamin' Hot", 23000],
        ["Volcán con carne", 32000],
      ].map(([label, price]) => ({ label, price, line: `Esquite ${label.toLowerCase()}` })),
    },
    ...[
      ["Tacos vegetarianos", 26000],
      ["Quesadilla vegetariana", 18000],
      ["Quesadilla Azteca", 20000],
      ["Nachos vegetarianos", 28000],
      ["Burro vegetariano", 26000],
    ...
    ...[
      ["Limonada", 10000, "Bebidas", "Bebida"],
      ["Coca-Cola", 6000, "Bebidas", "Bebida"],
      ["Quatro", 6000, "Bebidas", "Bebida"],
      ["Bretaña", 7000, "Bebidas", "Bebida"],
      ["Postre de la semana", 17000, "Extras", "Extra"],
      ["Margarita tradicional", 26000, "Cócteles y cervezas", "Con alcohol"],
      ["Margarita fresa", 28000, "Cócteles y cervezas", "Con alcohol"],
      ["Margarita chelada", 29000, "Cócteles y cervezas", "Con alcohol"],
      ["Paloma", 18000, "Cócteles y cervezas", "Con alcohol"],
      ["Charro negro", 18000, "Cócteles y cervezas", "Con alcohol"],
      ...
      ["ChamoChela", 23000, "Cócteles y cervezas", "Con alcohol"],
